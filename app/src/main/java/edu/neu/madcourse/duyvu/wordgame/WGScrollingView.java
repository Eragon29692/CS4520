 ...
 */
public class WGScrollingView extends View {
   private Drawable mBackground;
   private int mScrollPos;

   public WGScrollingView(Context context) {
      super(context);
      init(null, 0);
   }

   public WGScrollingView(Context context, AttributeSet attrs) {
      super(context, attrs);
      init(attrs, 0);
   }

   public WGScrollingView(Context context, AttributeSet attrs, int defStyle) {
