...
public class WGTile {
    ...
    private View mView;
    private WGTile mSubTiles[];

    public WGTile(WGGameFragment game) {
        this.mGame = game;
    }

    public WGTile deepCopy() {
        WGTile tile = new WGTile(mGame);
        tile.setOwner(getOwner());
        if (getSubTiles() != null) {
            WGTile newTiles[] = new WGTile[9];
            WGTile oldTiles[] = getSubTiles();
    ...
    public WGTile[] getSubTiles() {
        return mSubTiles;
    }

    public void setSubTiles(WGTile[] subTiles) {
