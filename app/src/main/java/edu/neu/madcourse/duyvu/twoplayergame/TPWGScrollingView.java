 ...
 */
public class TPWGScrollingView extends View {
   private Drawable mBackground;
   private int mScrollPos;

   public TPWGScrollingView(Context context) {
      super(context);
      init(null, 0);
   }

   public TPWGScrollingView(Context context, AttributeSet attrs) {
      super(context, attrs);
      init(attrs, 0);
   }

   public TPWGScrollingView(Context context, AttributeSet attrs, int defStyle) {
